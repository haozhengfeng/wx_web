...
<html>
  ...
  <body>
    ...
    <div class="weui-flex" style="margin:40px 40px;padding: 0 20px;">
    	<div class="weui-flex__item"><div class="placeholder"><a href="javascript:document.getElementById('myForm').submit()" class="weui-btn weui-btn_primary" id="btn1">登录</a></div></div>
    </div>	
	</form>    
  </body>
</html>
