...
import com.back.menu.domain.Button;
import com.back.menu.domain.Matchrule;
...
public class MenuController {
    ...
    @ResponseBody
    public WeiXinError delConditional(HttpServletResponse resp) throws IOException{
        return menuService.delConditional();
    }
    
    @RequestMapping("/trymatch")
    @ResponseBody
    public WeiXinError trymatch(HttpServletResponse resp) throws IOException{
